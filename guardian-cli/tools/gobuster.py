...
class GobusterTool(BaseTool):
    ...
    def get_command(self, target: str, **kwargs) -> List[str]:
        ...
        # Wordlist
        default_wordlist = "/guardian/SecLists/Discovery/Web-Content/common.txt"
        wordlist = kwargs.get("wordlist", config.get("wordlist", default_wordlist))
        ...
        # Disable status-codes-blacklist if -s is set (to avoid conflict)
        command.extend(["--status-codes-blacklist", ""])  # disables default blacklist
